                            ...
                            <div class="row">
                                <div class="col-md-4">
                                    ...
                                    <div class="wrap-inputdate pos-relative txt10 size12 bo2 bo-rad-10 m-t-3 m-b-23">
                                        <s:textfield id="input-checkIn" name="checkIn" cssClass="my-calendar-in bo-rad-10 sizefull txt10 p-l-20" onkeydown="return false"/>
                                ...
                                <div class="col-md-4">
                                    ...
                                    <div class="wrap-inputdate pos-relative txt10 size12 bo2 bo-rad-10 m-t-3 m-b-23">
                                        <s:textfield id="input-checkOut" name="checkOut" cssClass="my-calendar-out bo-rad-10 sizefull txt10 p-l-20" onkeydown="return false"/>
                                ...
                                <div class="wrap-btn-booking flex-c-m m-t-6">
                                    <s:submit value="Next" cssClass="btn3 flex-c-m size13 txt11 trans-0-4" onclick="return myDateValidator();"/>
                                </div>
                            </s:form>
                        </div>
                    </div>

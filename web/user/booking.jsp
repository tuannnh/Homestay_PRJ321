            ...
            <nav class="navbar navbar-top navbar-expand navbar-dark bg-primary border-bottom ">
                <div class="container-fluid ">
                    <div class="collapse navbar-collapse justify-content-between" id="navbarSupportedContent">
                        <!-- Brand -->
                        <a class="h4 mb-0 text-white text-uppercase d-none d-lg-inline-block" href="booking.jsp">User Booking

                        </a>
                        <!-- Form -->

                        <s:form  cssStyle="display:none" action="SearchBookingAction" theme="simple" method="POST" cssClass="navbar-search navbar-search-dark form-inline mr-3 d-none d-md-flex ml-lg-auto">
                            <s:textfield cssStyle="display:none" name="searchBookingValue" cssClass="form-control"/>
                        ...
                        <h3>
                            ...
                            <button type="button" class="btn btn-primary btn-lg active" data-toggle="modal" data-target="#modal-form">UPDATE PROFILE</button>
                                            ...
                                            <s:form action="UpdateUserAction" method="POST" role="form" theme="simple">
                                                ...
                                                <div class="form-group">
                                                    <div class="input-group input-group-alternative">
                                                        ...
                                                        <s:textfield name="fullname" cssClass="form-control" pattern="[a-z A-Z]+" placeholder="Fullname" required="" value="%{#session.USEROBJECT.fullname}"/>
                                                    </div>
                                                </div>

                ...
                <div class="container-fluid ">
                    <div class="collapse navbar-collapse justify-content-between" id="navbarSupportedContent">
                        ...
                        <a class="h4 mb-0 text-white text-uppercase d-none d-lg-inline-block" href="history.jsp">Booking
                            History</a>
                        <!-- Form -->
                        <s:form cssStyle="display:none" action="SearchBillAction" theme="simple" method="POST" cssClass="navbar-search navbar-search-dark form-inline mr-3 d-none d-md-flex ml-lg-auto">
                            <s:textfield name="searchBillValue" cssClass="form-control" cssStyle="display:none"/>
                        </s:form>
                        ...
                        <h3>
                            ...
                            <s:a href="%{SearchBookingLink}" cssClass="btn btn-primary btn-lg active" role="button" aria-pressed="true">BOOKING</s:a>
                                <a class="btn btn-primary btn-lg active" role="button"

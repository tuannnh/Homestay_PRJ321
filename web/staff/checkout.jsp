...
<html>
    ...
    <body>
          <div class="header bg-primary pb-5 pt-5 pt-md-5">
                            ...
                            <s:form action="CreateBillAction" method="POST" role="form" theme="simple">
                                <div class="row">
                                    <span class="card-stats px-lg-5">
                                        Booking ID:
                                        <s:textfield name="bookingId" value="%{bookingId}" cssStyle="font-weight: 600 ;border: 0;background: transparent" readonly="true" disabled="disable"/>

                                    </span>
                                    <span class="card-stats px-lg-6">
                                        Username:
                                        <s:textfield name="username" value="%{booking.username}" cssStyle="font-weight: 600;border: 0;background: transparent" readonly="true" disabled="disable"/>
                                    </span>
                                </div>
                                <br/>
                                <div class="row">
                                    <span class="card-stats px-lg-5">
                                        Check-in: 
                                        <s:textfield name="checkIn" value="%{booking.checkIn}" cssStyle="font-weight: 600;border: 0;background: transparent" readonly="true" disabled="disable"/>
                                    </span>
                                    <span class="card-stats px-lg-6" style="margin-left: 15px">
                                        Check-out: 
                                        <s:textfield name="checkOut" value="%{booking.checkOut}" cssStyle="font-weight: 600;border: 0;background: transparent" readonly="true" disabled="disable"/>
                                    </span>
                                </div>
                                <br/>
                                <div class="row">
                                    <span class="card-stats px-lg-5">
                                        Fullname:
                                        <s:textfield name="checkIn" value="%{booking.fullname}" cssStyle="font-weight: 600;border: 0;background: transparent" readonly="true" disabled="disable"/>
                                    </span>
                                    <span class="card-stats px-lg-6" style="margin-left: 10px">
                                        Coupon: 
                                        <s:textfield name="couponId" value="%{booking.couponId}" cssStyle="font-weight: 600;border: 0;background: transparent" readonly="true" disabled="disable"/>
                                    </span>
                                </div>
                                <br/>
                                <div class="row">
                                ...
                                <div class="row">
                                    <span class="card-stats px-lg-5" >
                                        Checkout by: 
                                        <s:textfield name="checkOutBy" value="%{#session.USER}" cssStyle="font-weight: 600;border: 0;background: transparent" readonly="true" disabled="disable"/>                                        
                                    </span>
                                    <span class="card-stats px-lg-5" style="margin-left: 10px">
                                        Total: 
                                        <strong> $ <s:textfield id="total" name="total" value="%{total}" cssStyle="font-weight: 600;border: 0;background: transparent" readonly="true" disabled="disable"/> </strong>
                                    </span>
                                </div>
                                <br/>
